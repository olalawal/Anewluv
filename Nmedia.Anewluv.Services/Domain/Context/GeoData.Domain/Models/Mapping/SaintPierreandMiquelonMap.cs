...
{
    public class SaintPierreandMiquelonMap : EntityTypeConfiguration<SaintPierreandMiquelon>
    {
        public SaintPierreandMiquelonMap()
        {
            // Primary Key
            ...
            this.ToTable("SaintPierreandMiquelon");

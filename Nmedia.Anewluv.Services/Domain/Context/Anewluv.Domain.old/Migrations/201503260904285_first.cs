    ...
    public partial class first : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.profiledatas", t => t.profile_id)
                ...
                c => new
                    {
                        ...
                        passwordchangeattempts = c.Int(),
                        status_id = c.Int(nullable: false),
                        securityquestion_id = c.Int(),
                    })
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.lu_profilestatus", t => t.status_id, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        quotaroleid = c.Int(),
                        quotavalue = c.Int(),
                        updaterprofile_id = c.Int(nullable: false),
                        updatedate = c.DateTime(),
                    })
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.profiledatas", t => t.updaterprofile_id, cascadeDelete: true)
                .Index(t => t.updaterprofile_id);
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        raterprofile_id = c.Int(nullable: false),
                ...
                .ForeignKey("dbo.profilemetadatas", t => t.raterprofile_id)
                .Index(t => t.rating_id)
                .Index(t => t.raterprofile_id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ratingvalues", "raterprofile_id", "dbo.profilemetadatas");
            ...
            DropForeignKey("dbo.communicationquotas", "updaterprofile_id", "dbo.profiledatas");
            ...
            DropIndex("dbo.ratingvalues", new[] { "raterprofile_id" });
            ...
            DropIndex("dbo.communicationquotas", new[] { "updaterprofile_id" });

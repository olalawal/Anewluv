...
namespace Anewluv.Services.DependencyResolution.Ninject.Modules
{
	public class CommonModule : NinjectModule
	{
		public override void Load()
		{
           ...
           // this.Bind<IUnitOfWorkAsync>().ToMethod(ctx => ctx.Kernel.Get<AnewluvContext>()).When(t => t.IsInjectingToRepositoryDataSourceOfNamespace("Anewluv.Services.Common.CommonService")).InScope(c => OperationContext.Current); ;

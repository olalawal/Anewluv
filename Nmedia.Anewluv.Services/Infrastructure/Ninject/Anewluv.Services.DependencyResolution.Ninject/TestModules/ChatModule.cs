...
namespace Anewluv.Services.DependencyResolution.Ninject.Modules
{
    public class ChatModule : NinjectModule
	{
		public override void Load()
		{
            ...
            //this.Bind<IUnitOfWorkAsync>().ToMethod(ctx => ctx.Kernel.Get<AnewluvContext>()).When(t => t.IsInjectingToRepositoryDataSourceOfNamespace("Anewluv.Services.Chat")).InScope(c => OperationContext.Current); 

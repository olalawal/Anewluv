...
namespace Nmedia.Infrastructure.Domain.Data.Notification
{
    ...
    public enum templatebodyenum : int
    {
        ...
        //contact us
        [Description("Dear <b>{0}</b> ,<p></p> Thank you for contacting us your message has been added to the support ticket list and you will get a response from our support staff within 24 hours <p></p> Our Support Team")]
        [EnumMember]
        ...
        [Description("A new profile for the user <b>{0}</b> with email  <b>{1}</b>  has been created on {2}")]
        [EnumMember]
        ...
        [Description("The  profile for the user {0} with email {1} has been <b> Activated </b> on {2}")]
        [EnumMember]
        ...
        //Sent member message 
        [Description("Dear {10}, <p></p>The member {1} has sent you an Email message , Please log into your account to view {1}'s Email message </br><p></p> <b>{2}</b>")]
        [EnumMember]
        ...
        [Description("Dear {0}, <p></p> <p></p>The member {1} has peeked at your profile , Please log into your account to view {2}'s details </br><p></p> <b>{3}</b>")]
        [EnumMember]
        ...
        [Description("Dear {0}, <p></p>The member {1} has likes you, Please log into your account to view {2}'s details </br><p></p> <b>{3}</b>")]
        [EnumMember]
        ...
        [Description("Dear {0}, <p></p>The member {1} has expressed interest your profile , Please log into your account and to view {2}'s details </br><p></p> <b>{3}</b>")]
        [EnumMember]
        ...
        [Description("Dear {0}, <p></p>The member {1} has wants to chat with you on, Please log into your account and check your chat requests to respond</br><p></p> <b>{2}</b>")]
        [EnumMember]
        ...
        [Description("Dear {0}, <p></p>The member {1} has sent you an off-line Chat message , Please log into your account to view {2}'s Chat message </br><p></p> <b>{3}</b>")]
        [EnumMember]
        MemberRecivedOfflineChatMessageMemberNotification = 24,
        [Description("The Member {0} has received an off-line chat request from the Member, {1}")]
        [EnumMember]
        MemberRecivedOfflineChatMessageAdminNotification = 25, //Photo
        [Description("Dear {0} ,</br> Thank you for uploading your photo </br>Unfortunately your photo did not meed our terms of service, please read the terms of service for acceptable photo formats and content. <p></p> This is the reason why : <p></p> <b>  {1} </b>")]
        [EnumMember]
        MemberPhotoRejectedMemberNotification = 26,
        [Description("The member {0} with the email address {1} has had their photo rejected by the administrator user with username {2}")]
        [EnumMember]
        MemberPhotoRejectedAdminNotification = 27,
        [Description("Dear {0} ,</br> Thank you for uploading your photo to Please allow up to 24 hours for your photo to be approved.")]
        [EnumMember]
        MemberPhotoUploadedMemberNotification = 28,
        [Description("A new photo for the user {0} with email address : {1}  has been uploaded on {2}")]
        [EnumMember]
        MemberPhotoUploadedAdminNotification = 29,
        [Description("Dear {0} , <p></p>Here are your {1} new matches for date : {2}  </br><p></p> <b>{3}</b>")]
        [EnumMember]
        ...
        [Description("A message from the user {0} with email address {1) was blocked because of the reason: {1}")]
        [EnumMember]
        ...
        [Description("Dear {0}, <p></p>The member {1} has sent you a friend request , Please log into your account and to view {1}'s details </br><p></p> <b>{2}</b>")]
        [EnumMember]
        ...
        //member password change notification
        [Description("Dear {0} ,<p></p> Your password has been changed if this is an error or you did not initiate this activity please contact us immediately at  <b>{1}</b>")]
        [EnumMember]
        MemberPasswordChangeMemberNotification = 37,
        [Description("An Password has been changed on {2} by the user <b>{0}</b> with email :<b>{1}</b>")]
        [EnumMember]

namespace Nmedia.Infrastructure.Domain.Notification.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Nmedia.Infrastructure.Domain.NotificationContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            MigrationsDirectory = @"Notification\Migrations";
        }

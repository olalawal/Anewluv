...
namespace LoggingLibrary
{
    public class ErroLogging : IDisposable
    {
        ...
        public ErroLogging(logapplicationEnum  Application)
        {
        ...
        public void WriteSingleEntry(logseverityEnum  severityLevelvalue, logenviromentEnum enviroment,Exception referedexception,int? profileid=null,
                                    HttpContextBase context = null,bool? sendnotification= true )
        {
          ...
          //  {
            ...
            try
            {
                    ...
                    Channelfactoryhelper.Service<IErrorLoggingService>.Authheader = "Y2FzZTpkcml2ZTMzMw==";
                    Channelfactoryhelper.Service<IErrorLoggingService>.Use(d =>
                    {
                       ...
                       // var id = d.WriteCompleteLogEntry(CreateErrorLog(severityLevelvalue,referedexception,profileid,context));
                        ...
                        var result = d.BeginWriteCompleteLogEntry(CreateErrorLog(severityLevelvalue,enviroment, referedexception, profileid, context), null, null);
                        oLogEntry.id = d.EndWriteCompleteLogEntry(result);
                    }
                    );
                ...
                catch (Exception ex)
                {
                   //we get an error trying to log log it here I guess i.e connecting or watatever
                    ...
                    Channelfactoryhelper.Service<IErrorLoggingService>.Use(d =>   
                        ...
                        // errorlog dd = CreateErrorLog(severityLevelvalue, referedexception,username,null);
                            var result = d.BeginWriteCompleteLogEntry(CreateErrorLog(logseverityEnum.CriticalError, enviroment, ex, null, context), null, null);
                        oLogEntry.id = d.EndWriteCompleteLogEntry(result);
                    }
                 );
                }
            ...
            if (sendnotification == true)
            {
                try
                {
                    ...
                    // Channelfactoryhelper.Service<IAnewluvNotificationService>.Authheader = "Y2FzZTpkcml2ZTMzMw==";
                    // Channelfactoryhelper.Service<IAnewluvNotificationService>.Use(d =>
                    //{
                    //    d.senderrormessage(oLogEntry, addresstypeenum.Developer.ToString());
                    //}
                    //);

                     Channelfactoryhelper.UsingContract<IAnewluvNotificationService>(d =>
                     {
                         var result = d.Beginsenderrormessage(oLogEntry, addresstypeenum.Developer.ToString(), null, null);
                ...
                {
                   // //write error directly
                   // Nmedia.Infrastructure.Channelfactoryhelper.Service<IErrorLoggingService>.Use(d =>
                   // {
        ...
        public errorlog CreateErrorLog(logseverityEnum severityLevelvalue, logenviromentEnum enviroment,Exception referedexception, int? profileid = null,

...
namespace Shell.MVC2.Controllers
{
    public class AdminTestController : Controller
    {
        ...
        public AdminTestController(AnewLuvFTSEntities _db, AdminPhotoModel _adminPhoto)
       {
           db = _db;
        ...
        public ActionResult _PhotoEdit(AdminPhotoModel Photo)
        {
           ...
           // string user = ProfileID;
            ...
            return RedirectToAction("_PhotoEdit", "AdminTest", new System.Web.Routing.RouteValueDictionary(

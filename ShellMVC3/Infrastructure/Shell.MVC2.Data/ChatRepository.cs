   ...
   public  class ChatRepository :   ChatRepositoryBase, IChatRepository 
    {
      ...
      // private IChatRepository _chatcontext;

       public ChatRepository(ChatContext chatcontext, AnewluvContext datingcontext) 
           :base(chatcontext,datingcontext)
       {
        ...
        //   public IQueryable<ChatUser> GetOnlineAllowedUsersInRooms(List<ChatRoom> rooms)
        //{
        //    return _chatcontext.Entry(rooms)
        //                 .Collection(r => r.AllowedUsers)
        //                 .Query().Online();
        //   }
       ...
       public void RemoveUserRoom(ChatUser user, ChatRoom room)
        ...
        {
            ChatUser user = this.GetUserByName(name);
        ...
        public ChatRoom VerifyRoom( string roomName, bool mustBeOpen = true)
        {
            ...
            //3-24-2011 added code to get the room if it already existed 
            ChatRoom room = this.GetRoomIfCreatedBefore(roomName);
        ...
        public ChatUser VerifyUserId(string userId)
        {
            ...
            ChatUser user = this.GetUserById(userId);

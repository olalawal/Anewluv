...
namespace Shell.MVC2.DependencyResolution.Ninject.Modules
{
    ...
    public class MemberActionsModuleUnitOfWork : NinjectModule
    {
        /// <summary>
        /// 5-12-2014 olawal
        ...
        public override void Load()
        {
            ...
            this.Bind<IUnitOfWork>().ToMethod(ctx => ctx.Kernel.Get<AnewluvContext>()); //.When(t => t.IsInjectingToRepositoryDataSourceOfNamespace("WellsFargo.Promotion.Services.PromotionService"));
            // this.Unbind(typeof(DbContext));
            this.Bind<DbContext>().ToMethod(ctx => ctx.Kernel.Get<AnewluvContext>()); //.When(t => t.IsInjectingToRepositoryDataSourceOfNamespace("WellsFargo.Promotion.Services.PromotionService"));
